...
class SplashScreen(QWidget):
    ...
    def initUI(self):
        ...
        self.labelLoading.setText('By- Rohan☻...')

    def loading(self):
        self.progressBar.setValue(self.counter)

        if self.counter == int(self.n * 0.3):
            self.labelDescription.setText('<strong>Connecting Database...</strong>')
        elif self.counter == int(self.n * 0.6):
            self.labelDescription.setText('<strong>Ready to go...</strong>')
...
class MyApp(QWidget):
    def __init__(self):
        ...
        l1 = tk.Label(window, text="Name",bg="orange", font=("Algerian",20),fg="black")
        l1.grid(column=0, row=0)
        t1 = tk.Entry(window, width=50, bd=5)
        t1.grid(column=1, row=0)

        l2 = tk.Label(window, text="Age", font=("Algerian",20),fg="black",bg="orange")
        l2.grid(column=0, row=1)
        t2 = tk.Entry(window, width=50, bd=5)
        t2.grid(column=1, row=1)

        l3 = tk.Label(window, text="Address", font=("Algerian",20),fg="black",bg="orange")
        ...
        def train_classifier():
            ...
            if(id1==0):
                ...
                data_dir="D:/projects/facerecognization/data"
...
##############################################################################
        b1 = tk.Button(window, text="Training", font=("Algerian",20),bg="yellow",fg="black",command=train_classifier)
...
#######################################################################################
        b2 = tk.Button(window, text="Detect the faces", font=("Algerian",20), bg="yellow", fg="black",command=detect_face)
...
###################################################################################
        ...
        b3 = tk.Button(window, text="Generate dataset", font=("Algerian",20), bg="yellow", fg="black", command=generate_dataset)
